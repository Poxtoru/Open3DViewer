...
void SIM::Coin3D::Quarter::SignalThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SignalThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (SignalThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignalThread::triggerSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SIM::Coin3D::Quarter::SignalThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_SIM__Coin3D__Quarter__SignalThread.data,
    qt_meta_data_SIM__Coin3D__Quarter__SignalThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
