...
public:
    ...
    void grabMouseModel(View3DInventor*);
 ...
 */
class BaseMouseSelection : public AbstractMouseSelection
{
public:
    BaseMouseSelection();
 ...
 * \author Werner Mayer
 */
class PolyPickerSelection : public BaseMouseSelection
{
public:
    PolyPickerSelection();
 ...
 * \author Werner Mayer
 */
class PolyClipSelection : public PolyPickerSelection
{
public:
    PolyClipSelection();
 ...
 * \author Werner Mayer
 */
class FreehandSelection : public PolyPickerSelection
{
public:
    FreehandSelection();
 ...
 * \author Werner Mayer
 */
class RubberbandSelection : public BaseMouseSelection
{
public:
    RubberbandSelection();
 ...
 * \author Werner Mayer
 */
class RectangleSelection : public RubberbandSelection
{
public:
    RectangleSelection();
 ...
 * \author Werner Mayer
 */
class BoxZoomSelection : public RubberbandSelection
{
public:
    BoxZoomSelection();
    ~BoxZoomSelection();
