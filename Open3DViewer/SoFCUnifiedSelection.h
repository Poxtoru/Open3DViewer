...
#ifndef SOFCUNIFIEDSELECTION_H
#define SOFCUNIFIEDSELECTION_H
...
#include <Open3DViewer\SoFCSelectionContext.h>
#include <Open3DViewer\ViewProviderPartExt.h>



class DLLExport SoFCSeparator : public SoSeparator {
	typedef SoSeparator inherited;

	SO_NODE_HEADER(SoFCSeparator);
...
class DLLExport SoSelectionRoot : public SoFCSeparator {
	typedef SoFCSeparator inherited;

	SO_NODE_HEADER(SoSelectionRoot);

public:
	static void initClass(void);
	static void finish(void);
	SoSelectionRoot(bool trackCacheMode = false);
...
protected:
	virtual ~SoSelectionRoot();

	void renderPrivate(SoGLRenderAction *, bool inPath);
	bool _renderPrivate(SoGLRenderAction *, bool inPath);

	class Stack : public std::vector<SoSelectionRoot*> {
	public:
		std::unordered_set<SoSelectionRoot*> nodeSet;
		size_t offset = 0;
	};
	...
	static SoSelectionRoot *ShapeColorNode;
...
class DLLExport SoFCUnifiedSelection : public SoSeparator {
	typedef SoSeparator inherited;
...
class DLLExport SoSelectionElementAction : public SoAction
{
...
class DLLExport SoHighlightElementAction : public SoAction
{
...
class DLLExport SoVRMLAction : public SoAction
{
...
class DLLExport SoFCPathAnnotation : public SoSeparator {
	typedef SoSeparator inherited;
