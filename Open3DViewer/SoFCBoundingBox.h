 ...
 * @author Josh Grant
 */
class DLLExport SoFCBoundingBox : public SoShape {
    typedef SoShape inherited;

    SO_NODE_HEADER(SoFCBoundingBox);
 ...
 * @author Werner Mayer
 */
class DLLExport SoSkipBoundingGroup : public SoGroup {
    typedef SoGroup inherited;

    SO_NODE_HEADER(SoSkipBoundingGroup);
