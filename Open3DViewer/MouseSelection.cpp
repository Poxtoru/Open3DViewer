...
void AbstractMouseSelection::grabMouseModel(View3DInventor* viewer)
{
    _pcView3D = viewer;
...
void PolyPickerSelection::initialize()
{
    ...
    _pcView3D->setRenderType(View3DInventor::Image);
    _pcView3D->redraw();
...
void PolyPickerSelection::terminate()
{
    ...
    _pcView3D->setRenderType(View3DInventor::Native);
    _pcView3D->redraw();
}
