 ...
 *                                                                         *
 ***************************************************************************/
#include <Open3DViewer\DualQuaternion.h>
#include <cassert>
...
DualQuat::DualQuat(DualQuat re, DualQuat du)
	: x(re.x.re, du.x.re),
	y(re.y.re, du.y.re),
	z(re.z.re, du.z.re),
	w(re.w.re, du.w.re)
...
double DualQuat::dot(DualQuat a, DualQuat b)
{
...
DualQuat DualQuat::pow(double t, bool shorten) const
{
