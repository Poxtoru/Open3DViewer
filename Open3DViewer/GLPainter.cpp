...
using namespace Gui;
TYPESYSTEM_SOURCE_ABSTRACT(GLGraphicsItem, Base::BaseClass)
...
Rubberband::Rubberband(View3DInventor* v) : viewer(v)
{
...
void Rubberband::setViewer(View3DInventor* v)
{
    viewer = v;
}
...
Polyline::Polyline(View3DInventor* v) : viewer(v)
{
    x_new = y_new = 0;
    working = false;
    closed = true;
...
void Polyline::setViewer(View3DInventor* v)
{
    viewer = v;
}
