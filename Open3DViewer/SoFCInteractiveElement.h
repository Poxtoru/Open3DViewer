 ...
 * @author Werner Mayer
 */
class DLLExport SoFCInteractiveElement : public SoReplacedElement {
...
class DLLExport SoGLWidgetElement : public SoElement {
...
class DLLExport SoGLRenderActionElement : public SoElement {
  typedef SoElement inherited;
...
class DLLExport SoGLWidgetNode : public SoNode {
...
class DLLExport SoGLVBOActivatedElement : public SoElement {
  typedef SoElement inherited;
