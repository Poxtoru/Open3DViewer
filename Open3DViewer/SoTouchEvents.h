...
class DLLExport SoGestureEvent : public SoEvent {
    SO_EVENT_HEADER();
public:
...
class DLLExport SoGesturePanEvent : public SoGestureEvent {
    SO_EVENT_HEADER();
public:
...
class DLLExport SoGesturePinchEvent : public SoGestureEvent {
    SO_EVENT_HEADER();
public:
    static void initClass(){
...
class DLLExport SoGestureSwipeEvent : public SoGestureEvent {
    SO_EVENT_HEADER();
public:
    static void initClass(){
...
class DLLExport GesturesDevice : public Quarter::InputDevice {
public:
