 ...
 * @author Werner Mayer
 */
class DLLExport NavigationStyleEvent : public QEvent
{
public:
 ...
 * @author Werner Mayer
 */
class DLLExport NavigationStyle : public Base::BaseClass
{
    TYPESYSTEM_HEADER();
...
public:
	...
	virtual QString getTypeName() { return QString("NavigationStyle"); };
 ...
 * @author Werner Mayer
 */
class DLLExport UserNavigationStyle : public NavigationStyle {
    TYPESYSTEM_HEADER();
...
public:
	...
	QString getTypeName() override { return QString("UserNavigationStyle"); };
};

class DLLExport InventorNavigationStyle : public UserNavigationStyle {
...
public:
    ...
    virtual std::string userFriendlyName() const;
	QString getTypeName() override { return QString("InventorNavigationStyle"); };
...
class DLLExport CADNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~CADNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("CADNavigationStyle"); };
...
class DLLExport RevitNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~RevitNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("RevitNavigationStyle"); };
...
class DLLExport BlenderNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~BlenderNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("BlenderNavigationStyle"); };
...
class DLLExport MayaGestureNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~MayaGestureNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("MayaGestureNavigationStyle"); };
...
class DLLExport TouchpadNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~TouchpadNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("TouchpadNavigationStyle"); };
...
class DLLExport OpenCascadeNavigationStyle : public UserNavigationStyle {
    typedef UserNavigationStyle inherited;
...
public:
    ...
    ~OpenCascadeNavigationStyle();
    const char* mouseButtons(ViewerMode);
	QString getTypeName() override { return QString("OpenCascadeNavigationStyle"); };
...
Q_DECLARE_OPERATORS_FOR_FLAGS(NavigationStyle::RotationCenterModes)
